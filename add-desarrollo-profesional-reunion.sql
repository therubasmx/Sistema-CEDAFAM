-- Reuniones de Coordinación Desarrollo Profesional (con invitados específicos).
-- Cambio de esquema aditivo: agrega el valor DEVELOPMENT_MEETING al enum EventKind.
--
...
ALTER TYPE "EventKind" ADD VALUE IF NOT EXISTS 'DEVELOPMENT_MEETING';
